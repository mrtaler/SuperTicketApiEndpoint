namespace SuperTicketApi.Application.Seedwork.Common
{
        ...
        where TEntity : DomainEntity, new() where TEntityDto : BusinesEntity, new()
    {
        ...
        #region Implementation of IEditableService<TEntity,TEntityDto>
        ...
        /// <inheritdoc />
        public TEntityDto Add(TEntityDto item)
        {
            throw new NotImplementedException();
        }
        ...
        /// <inheritdoc />
        public IList<TEntityDto> Add(IList<TEntityDto> items)
        {
            throw new NotImplementedException();
        }
        ...
        /// <inheritdoc />
        public void Remove(TEntityDto item)
        {
            throw new NotImplementedException();
        }
        ...
        /// <inheritdoc />
        public void Remove(IList<TEntityDto> items)
        {
            throw new NotImplementedException();
        }
        ...
        /// <inheritdoc />
        public TEntityDto Modify(TEntityDto item)
        {
            throw new NotImplementedException();
        }

        /// <inheritdoc />
        public IEnumerable<TEntity> Modify(IEnumerable<TEntity> items)
        {
            throw new NotImplementedException();
        }

        /// <inheritdoc />
        public IList<TEntityDto> Modify(IList<TEntityDto> items)
        {
            throw new NotImplementedException();
        }

        /// <inheritdoc />
        public void Refresh(TEntity item)
        {
            throw new NotImplementedException();
        }

        /// <inheritdoc />
        public void Refresh(TEntityDto item)
        {
            throw new NotImplementedException();
        }
